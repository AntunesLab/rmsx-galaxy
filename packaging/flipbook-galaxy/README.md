# Flipbook Galaxy Runtime Packaging
...
```bash
docker build \
  -t ghcr.io/antuneslab/flipbook-galaxy:0.2.3-galaxy0 \
  -t flipbook-galaxy:0.2.3-galaxy0 \
...
4. Move exact package versions from this scaffold into the Conda recipe and `tools/flipbook/macros.xml`.
