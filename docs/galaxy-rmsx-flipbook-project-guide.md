...
- Minimal RMSX wrapper: accept a structure and trajectory, expose essential parameters, run RMSX non-interactively, and produce Galaxy-friendly tables, plots, logs, and optional static report assets.
...
- A staged implementation plan for a minimal RMSX Galaxy wrapper and later visualization routes.
